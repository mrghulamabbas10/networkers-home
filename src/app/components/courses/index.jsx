  ...
  return (
    <div className=' border-b  border-borderColor'>
      <Container maxWidth='xl'>
        <div className='border-l border-borderColor lg:pt-32 lg:pb-12'>
          <Container
            maxWidth='lg'
            className=''
          >
              ...
              >
                <div className='flex gap-5 items-center ml-10 py-3 border-b-2 border-primary text-xl text-primary '>
                  ...
                  <input
                    ...
                    placeholder='Find your favourite course'
                  />
                </div>
                          ...
                          <div className='flex gap-5 '>
                            <div className='mt-3'>
                              <p className='text-[#363636] text-lg'>
                                ...
                                principles of UI/UX design, including user
                                research, information architecture, wireframing,
                                prototyping, usability testing, and visual
                                design. <br /> Courses may also cover specific
                                tools and software used in the industry, such as{' '}
                                <b>Adobe XD, Sketch</b>, or <b>Figma</b>.
                              </p>
